...
provides account objects (account, user) for team using PostgreSQL's schema.
...
== Development
  ...
  % bundle exec foreman run ruby -I.:test test/models/locker_room/account_test.rb -n /xxx/
