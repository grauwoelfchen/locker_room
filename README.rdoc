...
=== routes
  ...
  Routes for LockerRoom::Engine:
      ...
      team_settings GET    /settings/team(.:format)               locker_room/settings/teams#edit
                    PATCH  /settings/team(.:format)               locker_room/settings/teams#update
  ...
  confirm_team_type POST   /settings/team/confirm_type(.:format)  locker_room/settings/teams#confirm_type
