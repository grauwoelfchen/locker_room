...
provides user objects (team, user and membership) for team application.
...
=== routes
  ...
  Routes for LockerRoom::Engine:
      logout GET    /signout(.:format) locker_room/member/sessions#destroy
             DELETE /signout(.:format) locker_room/member/sessions#destroy
       login GET    /signin(.:format)  locker_room/member/sessions#new
             POST   /signin(.:format)  locker_room/member/sessions#create
registration GET    /signup(.:format)  locker_room/member/users#new
             POST   /signup(.:format)  locker_room/member/users#create
        root GET    /                  locker_room/member/storages#show
